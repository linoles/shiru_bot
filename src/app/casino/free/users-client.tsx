      ...
      <div className="min-h-screen bg-background text-foreground dark overflow-hidden overflow-x-hidden overflow-y-hidden">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-center w-full h-12 mt-2">
            ...
            <span className="text-sm text-muted-foreground ml-2 py-3 px-2 bg-inherit min-w-[80vw] text-start max-w-[80vw] border-b border-border">{users.filter(user => user.freeCasinoProps.done > 0).length > 0 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[0].tgNick : "FIRST PLACE"} | @{users.filter(user => user.freeCasinoProps.done > 0).length > 0 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[0].tgUsername : "USERNAME"} | {users.filter(user => user.freeCasinoProps.done > 0).length > 0 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[0].freeCasinoProps.points : "POINTS"}</span>
          </div>
          <div className="flex items-center justify-center w-full h-12 mt-2">
            <span className="text-sm text-muted-foreground ml-2 py-3 px-2 bg-inherit min-w-[80vw] text-end max-w-[80vw] border-b border-border">{users.filter(user => user.freeCasinoProps.done > 0).length > 1 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[1].freeCasinoProps.points : "POINTS"} | @{users.filter(user => user.freeCasinoProps.done > 0).length > 1 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[1].tgUsername : "USERNAME"} | {users.filter(user => user.freeCasinoProps.done > 0).length > 1 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[1].tgNick : "SECOND PLACE"}</span>
          ...
          <div className="flex items-center justify-center w-full h-12 mt-2">
            ...
            <span className="text-sm text-muted-foreground ml-2 py-3 px-2 bg-inherit min-w-[80vw] text-start max-w-[80vw] border-b border-border">{users.filter(user => user.freeCasinoProps.done > 0).length > 2 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[2].tgNick : "THIRD PLACE"} | @{users.filter(user => user.freeCasinoProps.done > 0).length > 2 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[2].tgUsername : "USERNAME"} | {users.filter(user => user.freeCasinoProps.done > 0).length > 2 ? users.sort((a, b) => b.freeCasinoProps.points - a.freeCasinoProps.points)[2].freeCasinoProps.points : "POINTS"}</span>
          </div>
        </div>
      </div>
    </div>
